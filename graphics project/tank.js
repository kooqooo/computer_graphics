...
var vertices = [
    /***         몸체         ***/
    vec4( -0.25, -0.2,  0.4, 1.0 ),
    vec4( -0.25,  0.0,  0.4, 1.0 ),
    vec4( 0.25,  0.0,  0.4, 1.0 ),
    vec4( 0.25, -0.2,  0.4, 1.0 ),
    vec4( -0.25, -0.2,  -0.4, 1.0 ),
    vec4( -0.25,  0.0,  -0.4, 1.0 ),
    ...
    /***         앞 범퍼        ***/
    vec4( -0.25, -0.35/2,  0.85/2, 1.0 ),
    vec4( -0.25, -0.15/2,  0.45, 1.0 ),
    vec4( 0.25,  -0.15/2,  0.45, 1.0 ),
    vec4( 0.25, -0.35/2,  0.85/2, 1.0 ),
    vec4( -0.25, -0.2,  0.4, 1.0 ),
    vec4( -0.25,  0.0,  0.4, 1.0 ),
    ...
    /***         윗 범퍼         ***/
    vec4( -0.25, 0.0,  -0.35, 1.0 ),
    vec4( -0.25,  0.15/2,  -0.4, 1.0 ),
    vec4( 0.25,  0.15/2,  -0.4, 1.0 ),
    vec4( 0.25, 0.0,  -0.35, 1.0 ),
    vec4( -0.25, 0.0,  -0.5, 1.0 ),
    vec4( -0.25,  0.15/2,  -0.5, 1.0 ),
    vec4( 0.25,  0.15/2,  -0.5, 1.0 ),
    vec4( 0.25, 0.0,  -0.5, 1.0 ),

    /***         터렛         ***/
    vec4( -0.2, 0.0,  0.2, 1.0 ),
    vec4( -0.2,  0.1,  0.15, 1.0 ),
    vec4( 0.2,  0.1,  0.15, 1.0 ),
    vec4( 0.2, 0.0,  0.2, 1.0 ),
    vec4( -0.2, 0.0,  -0.4, 1.0 ),
    vec4( -0.2,  0.1,  -0.35, 1.0 ),
    vec4( 0.2,  0.1,  -0.35, 1.0 ),
    vec4( 0.2, 0.0,  -0.4, 1.0 ),

    /***         포신        ***/
    vec4( -0.05/2, 0.1,  0.7, 1.0 ),
    vec4( -0.05/2,  0.15,  0.7, 1.0 ),
    vec4( 0.05/2,  0.15,  0.7, 1.0 ),
    vec4( 0.05/2, 0.1,  0.7, 1.0 ),
    vec4( -0.05/2, 0.05,  0.15, 1.0 ),
    vec4( -0.05/2,  0.1,  0.15, 1.0 ),
    vec4( 0.05/2,  0.1,  0.15, 1.0 ),
    vec4( 0.05/2, 0.05,  0.15, 1.0 )
...
window.onload = function init() {
    ...
    projection = ortho(-1, 1, -1, 1, -1000, 1000);
